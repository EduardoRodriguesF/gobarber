...
describe('UpdateUserAvatar', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    updateAvatar = new UpdateUserAvatarService_1.default(fakeUsersRepository, fakeStorageProvider);
    ...
    it('should not be able to update avatar from a non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
